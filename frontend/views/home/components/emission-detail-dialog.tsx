...
export function EmissionDetailsDialog({ open, onOpenChange, record }: EmissionDetailsDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Emission Details</DialogTitle>
          <DialogDescription>Detailed information about this calculation</DialogDescription>
        </DialogHeader>
